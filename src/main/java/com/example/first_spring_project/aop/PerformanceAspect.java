package com.example.first_spring_project.aop;
...
public class PerformanceAspect {
    // 특정 어노테이션을 대상 지정
    @Pointcut("@annotation(com.example.first_spring_project.annotation.RunningTime)")
    private void enableRunningTime() {

    }

    // 기본 패키지의 모든 메소드
    @Pointcut("execution(* com.example.first_spring_project.*.*(..))")
    private void cut() {
